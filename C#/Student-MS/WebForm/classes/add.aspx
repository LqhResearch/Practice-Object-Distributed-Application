        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="d-flex-center">
                    <asp:Button ID="btnSubmit" CssClass="btn btn-success mx-1" runat="server" Text="Thêm" OnClick="btnSubmit_Click" />
                    <a class="btn btn-danger mx-1" href="/classes/list.aspx">Hủy</a>
                </div>
            </div>
        </div>
    </div>
