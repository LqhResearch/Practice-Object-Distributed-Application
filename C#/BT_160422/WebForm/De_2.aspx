<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="De_2.aspx.cs" Inherits="WebForm.De_2" %>
    ...
    <div class="row g-0">
        <div class="col-md-4 p-3">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <p>Đếm xem có bao nhiêu số vừa chia hết cho 4 vừa chia hết cho 5, kiểm tra số vừa đếm là chẵn hay lẻ.</p>
                </div>
            </div>
        </div>
