<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="De_1.aspx.cs" Inherits="WebForm.De_1" %>
    ...
    <div class="row g-0">
        <div class="col-md-4 p-3">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <p>Đếm có bao nhiêu số chia hết cho 2 nhưng không chia hết cho 4. In ra các số đó.</p>
                </div>
            </div>
        </div>
