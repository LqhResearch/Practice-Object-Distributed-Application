<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="WebForm.Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="my-3">
        <h2 class="text-primary text-center">Cập nhật sinh viên</h2>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <asp:TextBox ID="txtMaNV" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                </div>
                <div class="col-md-6 mb-3">
