 ...
 * @author New King
 */
public class BT_05032022_De_2 extends javax.swing.JFrame {

    /**
     * Creates new form BT_05032022_De_1
     */
    public BT_05032022_De_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtTitle.setRows(2);
        txtTitle.setText("Đề bài số 2: Viết chương trình nhập vào 5 số nguyên bất kỳ, đếm xem có bao nhiêu số chia hết cho 3 nhưng không chia hết cho 6. Tính tổng các số chẵn và số lẻ");
        ...
        txtAns3.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
    ...
    private void btnAnsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnsActionPerformed
        try {
            ...
            txtAns1.setText("Có " + sc.nextLine() + " số chia hết cho 3 không chia hết cho 6");
            txtAns2.setText("Tổng các số lẻ = " + sc.nextLine());
            txtAns3.setText("Tổng các số chẩn = " + sc.nextLine());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_05032022_De_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BT_05032022_De_2().setVisible(true);
            }
        });
    }
