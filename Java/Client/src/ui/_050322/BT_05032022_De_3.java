 ...
 * @author New King
 */
public class BT_05032022_De_3 extends javax.swing.JFrame {

    /**
     * Creates new form BT_05032022_De_1
     */
    public BT_05032022_De_3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtTitle.setRows(2);
        txtTitle.setText("Đề bài số 3: Viết chương trình nhập vào 5 số nguyên bất kỳ, đếm xem có bao nhiêu số lẻ, bao nhiêu số chẵn, sắp tăng dần các số chẵn.");
    ...
    private void btnAnsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnsActionPerformed
        try {
            ...
            txtAns1.setText("Có " + sc.nextLine() + " số lẻ");
            txtAns2.setText("Có " + sc.nextLine() + " số chẫn");
            txtAns3.setText("Mảng số chẫn tăng dần: " + sc.nextLine());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT_05032022_De_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BT_05032022_De_3().setVisible(true);
            }
        });
    }
